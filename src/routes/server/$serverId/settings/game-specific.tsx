import GameSpecificSettingsSection from "@components/display/GameServer/GameServerSettings/sections/GameSpecificSettingsSection";
...
export const Route = createFileRoute("/server/$serverId/settings/game-specific")({
...
function RouteComponent() {
  ...
  if (!canAccess) {
    return <NoAccess element={t("components.GameServerSettings.tabs.gameSpecific")} />;
  }

  return <GameSpecificSettingsSection />;
}
