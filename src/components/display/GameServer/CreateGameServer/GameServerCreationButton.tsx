...
const GameServerCreationButton = () => {
  const {triggerNextPage, isLastPage, isPageValid, currentPage, creationState} = useContext(GameServerCreationContext);
  ...
  const buttonLabel = (() => {
    switch (currentPage) {
      ...
      case 1:
        return creationState.utilState.selectedTemplate ? "components.CreateGameServer.useTemplate" : "components.CreateGameServer.useNoTemplate";
      default:
