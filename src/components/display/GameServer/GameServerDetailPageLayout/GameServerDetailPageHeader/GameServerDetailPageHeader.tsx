...
const GameServerDetailPageHeader = (props: { gameServer: GameServerDto }) => {
  return (
    <div className="flex align-bottom items-end gap-12 border-b-4 border-button-primary-default py-4 justify-between">
      <div className={"text-2xl truncate text-ellipsis max-w-[45vw]"}>
