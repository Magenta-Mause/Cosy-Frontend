...
const ConstructionPlaceHouse = (props: {
    className?: string,
    style?: CSSProperties
}) => {
    return <a
        className={cn("block w-[30%] h-auto overflow-visible translate-x-[-9.3vw] translate-y-[0.1vw] aspect-video text-xs relative select-none", props.className)}
